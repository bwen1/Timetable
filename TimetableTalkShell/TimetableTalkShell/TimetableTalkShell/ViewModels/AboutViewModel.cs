...
namespace TimetableTalkShell.ViewModels
{
    ...
    public class AboutViewModel : ContentPage
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:TimetableTalkShell.ViewModels.AboutViewModel"/> class.
        /// </summary>
        public AboutViewModel()
        {
            ...
            //this.EmployeeDetails = new ObservableCollection<AboutModel>
            //{
            //    new AboutModel
            //    {
            //        EmployeeName = "Alice",
        ...
        //public ObservableCollection<AboutModel> EmployeeDetails { get; set; }
